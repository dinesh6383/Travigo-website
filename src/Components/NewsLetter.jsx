...
const NewsLetter = () => {
  return (
    <>
      <div className="p-5 bg-white/80 ring-1 ring-emrald-200 shadow-md shadow-emrald-300 rounded-lg max-w-5xl w-full ml-auto mr-auto mt-0 xl:w-[95vw] relative top-12">
        <div className="flex items-center justify-around lg:flex-col lg:gap-7">
